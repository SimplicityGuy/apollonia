        ...
        <div className="mt-6">
          <dl className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((item) => (
              <div
                key={item.name}
                className="relative overflow-hidden rounded-lg bg-white px-4 pt-5 pb-12 shadow sm:px-6 sm:pt-6 dark:bg-gray-800"
              >
                <dt>
                ...
                <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
                  ...
                  <div className="absolute inset-x-0 bottom-0 bg-gray-50 px-4 py-4 sm:px-6 dark:bg-gray-700">
                    <div className="text-sm">
                      <a
                        href={
                          item.name === 'Total Media Files'
                            ? '/files'
                            : item.name === 'Analyzed Files'
                              ? '/analytics'
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm leading-4 font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
          ...
          {isLoading ? (
            ...
            <>
              ...
              {recentFiles?.items && recentFiles.items.length > 0 && (
                <div className="mt-4 mb-4" data-testid="status-summary">
                  ...
                  <div className="flex flex-wrap gap-4 text-sm text-gray-600 dark:text-gray-400">
                    {(() => {
                      const statusCounts = recentFiles.items.reduce(
                        (acc, file) => {
              ...
              <div className="ring-opacity-5 mt-4 overflow-hidden shadow ring-1 ring-black md:rounded-lg">
