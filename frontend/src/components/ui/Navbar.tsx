...
export function Navbar() {
  ...
  return (
    <header
      role="banner"
      className="flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8 dark:border-gray-800 dark:bg-gray-950"
    >
      <nav>
        <button
          type="button"
        ...
        {/* Search */}
        <div className="flex hidden flex-1 gap-x-4 self-stretch lg:block lg:gap-x-6">
          <form className="relative flex flex-1" action="/search" method="GET">
            ...
            <input
              id="search-field"
              className="block h-full w-full border-0 py-0 pr-0 pl-8 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm dark:bg-gray-950 dark:text-white"
          ...
          <div className="flex items-center gap-x-4 lg:gap-x-6">
            <button
              type="button"
              className="relative -m-2.5 p-2.5 text-gray-400 hover:text-gray-500 dark:hover:text-gray-300"
